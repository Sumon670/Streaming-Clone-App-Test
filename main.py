...
#GUI
window = tk.Tk()
window.title("VideoClone v0.0.1 Alpha")
...
button_listen = tk.Button(window,text="Start Listening",width=50,command=start_listen)
button_listen.pack(anchor=tk.CENTER,expand=True)

button_camera = tk.Button(window,text="Start Camera",width=50,command=start_camera_streaming)
...
button_audio = tk.Button(window,text="Start Audio",width=50,command=start_audio_streaming)
